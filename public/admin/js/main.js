...
async function addActivities() {
    let activities = await getActivties();
...
async function editProfile() {
    ...
    let i = 1;
    profile.forEach((IndvProfile) => {
        let profiletHTML = `
          <tr>
            <td class="title">${IndvProfile.description}</td>
          </tr>`;
        //Insert HTML, there are 4 values we can choose for insertAdjacentHTML
        profileBlock.insertAdjacentHTML('beforeend',profiletHTML);
    })
}
...
async function editAbout() {
    ...
    let i = 1;
    about.forEach((about_me) => {
        let aboutHTML = `
          <tr>
            <td class="title">${about_me.description}</td>
          </tr>`;
        //Insert HTML, there are 4 values we can choose for insertAdjacentHTML
