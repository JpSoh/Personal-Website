    ...
    experiences.forEach((experience) => {
        ...
        <div class="individual-experience d-flex">
            ...
            <div class="experience-right vw-80">
                ...
                <a href="${experience.testimonial_link}" class="text-decoration-underline experience-link" target="_blank">See Testimonial</a>
            </div>
         </div>
        `
    ...
    educations.forEach((education) => {
        ...
        <div class="individual-educaion d-flex">
            ...
            <div class="education-right vw-80">
                ...
                <a href="${education.certification_link}" class="text-decoration-underline education-link" target="_blank">See Certification</a>
            </div>
      </div>
        `
